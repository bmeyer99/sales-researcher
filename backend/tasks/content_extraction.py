...
def extract_url_content_task(
    ...
    for index, url in enumerate(source_urls):
        self.update_state(
            state="PROGRESS",
            meta={"current": index + 1, "total": total_urls, "url": url},
        )
        ...
        try:
            ...
            logger.error(f"Error processing URL {url} in extract_url_content_task: {e}", exc_info=True)
